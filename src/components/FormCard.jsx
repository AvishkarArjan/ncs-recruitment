...
const FormCard = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-center min-h-screen bg-cover bg-center py-10"
    ...
    >
      ...
      {/* Form content */}
      <div className="relative z-10 w-full max-w-2xl p-8 bg-white rounded-xl shadow-2xl">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="text-gray-800 text-xs block mb-1">
              👤 Full Name
            </label>
            <input
              type="text"
              ...
              value={formData.fullName}
              onChange={handleChange}
              className="bg-white placeholder:text-gray-400 text-gray-900 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
              placeholder="Enter your full name"
            />
            {errors.fullName && (
              <p className="text-red-600 text-sm mt-1">{errors.fullName}</p>
          ...
          <div>
            <label className="text-gray-800 text-xs block mb-1">✏️ Year</label>
            <select
              name="year"
              value={formData.year}
              onChange={handleChange}
              className="bg-white text-gray-900 border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
            >
              <option value="" disabled>
                Select year
              </option>
          ...
          <div className="relative group mt-6">
            ...
            <button
              type="submit"
              className="relative w-full py-3 text-base font-bold text-white bg-gray-900 rounded-md hover:scale-105 transition duration-200 z-10"
            >
              Register{" "}
              <u>
                <i>Now</i>
