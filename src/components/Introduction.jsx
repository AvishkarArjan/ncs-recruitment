...
function Introduction() {
    ...
    return (
      <section className="flex flex-col items-center justify-center py-10 px-4 flex h-screen bg-cover bg-center "
      style={{
              backgroundImage:
                `url(${backgroundimage})`,
            }}>
        <div className="flex flex-col max-w-[1000px] w-full mx-auto items-center text-white">
          <div className="flex w-full mx-auto justify-between">
            ...
            <p className="text-xs text-black ">JSS Academy of Technical Education, Noida</p>
            </div>
             </div>
          <img src={logo}  width={100} className="rounded-lg shadow-[inset_0_0_0_2000px_rgba(0.5,0.5,0.5,0.5)] mm " alt="" />

          </div>
          <p className="mt-10 text-xs text-black ">JSS Mahavidyapeetha</p>
            <p className="text-xs font-bold text-black ">JSS Academy of Technical Education Noida</p>
            
          <p className="font-bold text-center text-black ">Department of Computer Science & Engineering </p>
          <p className=" text-xs text-black ">In collaboration with Nibble Computer Society</p>
          
          {/* <p className="text-xs mb-3">Presents</p> */}
          
          <div className="text-center">
          <img src={ncs} width={800} alt="" className="my-10 "/>
